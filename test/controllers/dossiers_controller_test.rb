...
class DossiersControllerTest < ActionController::TestCase
  ...
  test "should create dossier" do
    assert_difference('Dossier.count') do
      post :create, dossier: { data: @dossier.data, numero: @dossier.numero, oggetto: @dossier.oggetto, testo: @dossier.testo }
    end
  ...
  test "should update dossier" do
    patch :update, id: @dossier, dossier: { data: @dossier.data, numero: @dossier.numero, oggetto: @dossier.oggetto, testo: @dossier.testo }
    assert_redirected_to dossier_path(assigns(:dossier))
  end
