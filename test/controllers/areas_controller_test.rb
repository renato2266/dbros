...
class AreasControllerTest < ActionController::TestCase
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post :create, area: { ambit_id: @area.ambit_id, area_criminale: @area.area_criminale, note_area: @area.note_area }
    end
  ...
  test "should update area" do
    patch :update, id: @area, area: { ambit_id: @area.ambit_id, area_criminale: @area.area_criminale, note_area: @area.note_area }
    assert_redirected_to area_path(assigns(:area))
  end
